...
public class ProductViewVO implements Serializable {
    ...
    private static final long serialVersionUID = 7382561507813856185L;
    ...
    public static ProductViewVO bindData(ProProductDTO proProductDTO) {
        ProductViewVO model = new ProductViewVO();
        if (proProductDTO!=null) {
